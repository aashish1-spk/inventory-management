...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-asset/css/fontawesome-free/css/all.min.css') }}">
    <!-- Theme style -->
...
<body class="hold-transition login-page">
    ...
    <!-- ./wrapper -->
    <!-- jQuery -->
    <script src="{{ asset('admin-asset/js/jquery/jquery.min.js') }}"></script>
    <!-- Bootstrap 4 -->
    <script src="{{ asset('admin-asset/js/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <!-- AdminLTE App -->
