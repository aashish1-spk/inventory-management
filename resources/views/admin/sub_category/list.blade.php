    ...
    <div class="container-fluid">
        ...
        <form action="" method="get">
            <div class="card-header">
                ...
                <button type="button" onclick="window.location.href='{{ route('sub-categories.index') }}'" class="btn btn-default btn-sm">Reset
                </button>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        @if ($subCategories->isNotEmpty())
                            <!-- Code to display if $categories is not empty -->
...
function deleteCategory(id) {
    // Build the URL with the category ID
